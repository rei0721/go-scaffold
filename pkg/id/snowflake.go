// Package id 提供使用 Snowflake 算法的唯一 ID 生成
...
// snowflakeGenerator 使用 Twitter 的 Snowflake 算法实现 Generator
// Snowflake ID 结构(64位):
// - 1 位:未使用(始终为0)
...
// Default 创建一个使用 nodeID 1 的默认生成器
// 这是一个便捷函数,适合单机环境或快速开始
// 返回:
//
//	Generator: 默认的 ID 生成器
//
// 注意:
//
//	如果创建失败会 panic
